...
**Next:** CLN-09. **Active agents:** none. Cleanup automation Active. **Accepted 2026-09-10:** CLN-08 moves evaluation/campaign ownership and locks into internal/insighteval, retaining the narrow app adapter, CLI/wire identities, fixed grants, private artifacts, and fixture locations. Fresh review found no actionable issues and verified all 63 moved tests remain. Coordinator passed both exact commands, full Go/race tests, formatting, vet, native and Windows/Linux compile checks for both executables, and normalized production/dependency checks. No repairs or runtime platform claims; no live evaluation or qualification. Candidate SHA-256: e69a984329d26204ee629c89c4800949fb695b1e7d4f5706cd9a9612d4d51b3b. Evidence: .mini-orca/autopilot/cleanup/CLN-08/acceptance.json.
