> Historical record: completed CLN-01–12 cleanup, archived on 2026-09-11.
> Execution instructions below are inactive. Current work is in [the task queue](../tasks.md).
> The original content is retained; relative Markdown links were adjusted for this location.
...
- PLAN.md retains current cleanup state, every accepted cleanup evidence record,
  ...
  [improvement history](improvement-plan-2026-09.md).
- Former insights/runtime/campaign instructions and the complete recovery
  specification from **fe4cdad:docs/tasks.md** are in
  [insight history](insight-evaluation-2026-09.md).
- The complete [old-to-new heading map](improvement-plan-2026-09.md#old-to-new-anchor-map)
