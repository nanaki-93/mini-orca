...
@Serializable data class DeclarationValidation(val applicable: Boolean, @SerialName("scope_mode") val scopeMode: String, val diagnostics: List<DeclarationFinding> = emptyList(), val diff: UnifiedDiff)
...
@Serializable data class DraftCheckReport(@SerialName("target_path") val targetPath: String, val applicable: Boolean, val checks: List<DraftCheck> = emptyList(), @SerialName("draft_id") val draftId: String = "", @SerialName("draft_revision") val draftRevision: Long = 0, @SerialName("draft_hash") val draftHash: String = "", @SerialName("candidate_hash") val compositionHash: String = "", @SerialName("project_id") val projectId: String = "", @SerialName("project_revision") val projectRevision: String = "", @SerialName("base_file_hash") val baseFileHash: String = "")
@Serializable data class DraftCheck(val name: String, val required: Boolean = false, val state: String, val command: List<String> = emptyList(), val output: String = "", @SerialName("exit_code") val exitCode: Int = 0)
...
@Serializable data class StructuredProjectAnalysis(
...
@Serializable data class ProjectMetrics(val type: String = "", @SerialName("build_file") val buildFile: String = "", @SerialName("file_count") val fileCount: Int = 0, @SerialName("source_file_count") val sourceFileCount: Int = 0, @SerialName("total_lines") val totalLines: Int = 0, val languages: Map<String, Int> = emptyMap())
@Serializable data class AnalysisCoverage(val total: Int = 0, val fresh: Int = 0, val stale: Int = 0, val missing: Int = 0, val failed: Int = 0, val running: Int = 0)
@Serializable data class FindingCounts(val verified: Int = 0, @SerialName("ai_suggestions") val aiSuggestions: Int = 0)
...
@Serializable data class GoScanPhase(val name: String = "", val state: String = "", val command: List<String> = emptyList(), val output: String = "", @SerialName("exit_code") val exitCode: Int = 0)
@Serializable data class GoScanReport(@SerialName("project_id") val projectId: String = "", @SerialName("project_revision") val projectRevision: String = "", val status: String = "", @SerialName("started_at") val startedAt: String = "", @SerialName("updated_at") val updatedAt: String = "", @SerialName("completed_at") val completedAt: String = "", val phases: List<GoScanPhase> = emptyList())
