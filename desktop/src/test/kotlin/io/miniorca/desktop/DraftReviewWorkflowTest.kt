...
class DraftReviewWorkflowTest {
                    ...
                    "POST" to "/api/projects/current/drafts/draft/validate" ->
                        TransportResponse(
                            ...
                            draftJson(
                                ...
                                "validated",
                                validation =
                                    "{\"applicable\":true,\"scope_mode\":\"replace_symbol\",\"diff\":{\"old_path\":\"main.go\",\"new_path\":\"main.go\",\"lines\":[]}}"))
  ...
  private fun draft(revision: Long, hash: String, validation: DeclarationValidation?) =
      DeclarationDraft(
          "draft",
          "project",
          "revision",
  ...
  private fun draftJson(revision: Long, hash: String, validation: String) =
      "{\"id\":\"draft\",\"project_id\":\"project\",\"project_revision\":\"revision\",\"base_file_hash\":\"base\",\"target_path\":\"main.go\",\"mode\":\"replace_symbol\",\"target_symbol\":\"Run\",\"declaration\":\"func Run() error { return nil }\",\"imports\":[],\"revision\":$revision,\"hash\":\"$hash\",\"state\":\"valid\",\"validation\":$validation}"
}
