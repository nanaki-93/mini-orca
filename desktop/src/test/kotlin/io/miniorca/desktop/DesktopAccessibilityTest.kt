...
class DesktopAccessibilityTest {
    ...
    @Test fun keyboardRoutesCoverWorkspacesBugsDraftValidationAndChecks() {
        ...
        assertEquals(DesktopShortcut.FocusBugsFilters, desktopShortcut("F", primaryModifier = true, shift = true))
        assertEquals(DesktopShortcut.FocusDraft, desktopShortcut("D", primaryModifier = true, shift = true))
        assertEquals(DesktopShortcut.ValidateDraft, desktopShortcut("V", primaryModifier = true, shift = true))
