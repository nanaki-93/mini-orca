...
in-memory draft-discard decision. The Editor progress is a read-only
**Inspect → Edit → Review** indicator: successful validation opens the diff and Review,
where focused checks, exact Apply, receipt, and Undo remain together.
