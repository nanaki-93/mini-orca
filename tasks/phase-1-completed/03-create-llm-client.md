# Task 1.3: Create internal/llm/client.go

## Goal
Create a simple, single-responsibility LLM client. No router, no provider abstraction.
...
- `internal/agent/client.go` (task 1.4)
- `internal/agent/coder.go` (task 1.6)
- `internal/agent/tester.go` (task 1.6)
- `internal/agent/reviewer.go` (task 1.6)
- `internal/agent/registry.go` (task 1.5)
- `internal/agent/orchestrator.go` (task 1.7)
- `cmd/daemon/main.go` (task 1.8)

## Verification
- `go build ./internal/llm/...` succeeds
- No `model.` package references in this file
